...
class CustomResetPasswordForm(ResetPasswordForm):
    """
    Custom password reset form that uses username and redirects to security questions
    instead of sending emails
    """
    username = forms.CharField(
        max_length=150,
        label="Username",
        help_text="Enter your username to reset password using security questions",
